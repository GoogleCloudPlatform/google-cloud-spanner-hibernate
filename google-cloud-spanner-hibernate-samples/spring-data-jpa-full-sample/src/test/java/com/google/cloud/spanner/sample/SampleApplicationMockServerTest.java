  ...
  public static void setupQueryResults() {
    ...
    Statement tablesStatement =
        Statement.newBuilder(
            ...
            .to("VIEW")
            .build();
    mockSpanner.putStatementResult(StatementResult.query(tablesStatement, empty()));
    mockSpanner.putStatementResult(
        StatementResult.query(tablesStatement.toBuilder().bind("p2").to("").build(), empty()));

    // INDEXES - Register for both wildcard "%" and empty "" schema
    Statement indexesStatement =
        Statement.newBuilder(
            ...
            .to("%")
            .build();
    mockSpanner.putStatementResult(StatementResult.query(indexesStatement, empty()));
    mockSpanner.putStatementResult(
        StatementResult.query(indexesStatement.toBuilder().bind("p2").to("").build(), empty()));

    // COLUMNS - Register for both wildcard "%" and empty "" schema
    Statement columnsStatement =
        Statement.newBuilder(
            ...
            .to("%")
            .build();
    mockSpanner.putStatementResult(StatementResult.query(columnsStatement, empty()));
    mockSpanner.putStatementResult(
        StatementResult.query(columnsStatement.toBuilder().bind("p2").to("").build(), empty()));
