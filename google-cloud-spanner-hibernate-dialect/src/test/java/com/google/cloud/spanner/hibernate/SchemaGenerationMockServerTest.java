...
public class SchemaGenerationMockServerTest extends AbstractSchemaGenerationMockServerTest {
  ...
  public void testDropExistingSchema() {
    ...
    assertEquals("drop table if exists Account", request.getStatements(++index));
    assertEquals("drop table if exists Customer", request.getStatements(++index));
    assertEquals("drop table if exists Invoice", request.getStatements(++index));
    assertEquals("drop table if exists Singer", request.getStatements(++index));
