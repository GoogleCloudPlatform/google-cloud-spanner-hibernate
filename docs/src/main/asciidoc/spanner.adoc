...
| Decimal or arbitrary-precision numbers | Cloud Spanner does not support `java.sql` types of `NUMERIC` or `DECIMAL`
|===
...
Leaving out this annotation will cause a `BYTES` column to be used.
