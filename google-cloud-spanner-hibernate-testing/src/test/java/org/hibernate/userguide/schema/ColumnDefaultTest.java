...
public class ColumnDefaultTest extends BaseEntityManagerFunctionalTestCase {
    ...
    public void test() {
        ...
        doInJPA( this::entityManagerFactory, entityManager -> {
            ...
            // See https://github.com/GoogleCloudPlatform/google-cloud-spanner-hibernate/issues/75
            // ColumnDefault cannot be triggered because Spanner JDBC driver accepts all NULLs.
            assertNull( person.getName() );
            assertNull( person.getClientId() );
        } );
		//end::schema-generation-column-default-value-persist-example[]
    }

    //tag::schema-generation-column-default-value-mapping-example[]
    @Entity(name = "Person_column_default")
    @DynamicInsert
