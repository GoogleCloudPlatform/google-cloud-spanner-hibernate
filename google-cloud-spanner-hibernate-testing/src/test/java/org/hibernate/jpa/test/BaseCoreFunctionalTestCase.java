...
public abstract class BaseCoreFunctionalTestCase extends BaseUnitTestCase {
  ...
  protected Configuration constructConfiguration() {
    ...
    configuration.setProperty(
        AvailableSettings.CACHE_REGION_FACTORY, CachingRegionFactory.class.getName());
  ...
  protected void applyCacheSettings(Configuration configuration) {
    if (getCacheConcurrencyStrategy() != null) {
      configuration.setProperty(
          AvailableSettings.DEFAULT_CACHE_CONCURRENCY_STRATEGY, getCacheConcurrencyStrategy());
  ...
  protected StandardServiceRegistryImpl buildServiceRegistry(
    ...
    StandardServiceRegistryBuilder cfgRegistryBuilder =
        configuration.getStandardServiceRegistryBuilder();

    StandardServiceRegistryBuilder registryBuilder =
        new StandardServiceRegistryBuilder(bootRegistry, cfgRegistryBuilder.getAggregatedCfgXml())
  ...
  protected void prepareBasicRegistryBuilder(
  ...
  protected void cleanupTestData() throws Exception {
    if (isCleanupTestDataUsingBulkDelete()) {
      ...
      // we can'trely on a Bulk Delete query which will not clear the link tables in
      // @ElementCollection or unidirectional collections
      doInHibernate(
          this::sessionFactory,
          s -> {
