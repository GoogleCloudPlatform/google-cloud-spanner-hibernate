...
Spanner offers custom column types not commonly found in other databases.
This project offers https://docs.jboss.org/hibernate/orm/4.3/manual/en-US/html/ch06.html#types-custom[custom Hibernate type mappings] that correspond with these Spanner column types.
