...
NOTE: Deleting a row counts as one operation and inserting/updating rows count with the multiplicity of the number of columns they affect.
...
By default, Hibernate does not batch the statements that it sends to the JDBC driver.
