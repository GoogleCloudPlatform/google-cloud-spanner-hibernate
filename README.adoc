...
Maven coordinates for the official https://cloud-dot-devsite.googleplex.com/spanner/docs/open-source-jdbc[open source Cloud Spanner JDBC Driver].
...
NOTE: Hibernate ORM with Cloud Spanner is officially supported only with the https://cloud-dot-devsite.googleplex.com/spanner/docs/open-source-jdbc[open source Cloud Spanner JDBC Driver]. It does not support the https://cloud-dot-devsite.googleplex.com/spanner/docs/partners/drivers[Simba JDBC driver] at this time.
