 ...
 * Class#getDeclaredFields()} and as such, iteration order is not guaranteed. Iteration will not
 * include synthetic fields and can throw SecurityExceptions based on configured SecurityManager
 *
 * @see SecurityManager
 */
